...
const vacancies = [
  {
    ...
    badge: 'Yeni',
    title: 'Saç ustası',
    description: 'Müasir salonumuzda işləmək üçün təcrübəli saç ustası axtarırıq.',
    location: 'Bakı şəhəri, Nəsimi rayonu',
    type: 'Tam ştat',
    salary: '800–1500 AZN',
    requirements: ['Minimum 2 il təcrübə', 'Peşəkar sertifikat', 'Müştəri yönümlü yanaşma'],
  },
  {
    id: 2,
    badge: 'Yeni',
    ...
    type: 'Tam ştat',
    salary: '700–1300 AZN',
    requirements: ['Minimum 1 il təcrübə', 'Nail art bilikləri', 'Gel polish təcrübəsi'],
  },
  {
    id: 3,
    badge: 'Yeni',
    ...
    type: 'Part-time',
    salary: '600–1200 AZN',
    requirements: ['Portfolio tələb olunur', 'Gəlin makiyajı təcrübəsi', 'Öz alətləri'],
  },
]
...
const benefits = [
  {
    ...
    svg: (
      <svg width="26" height="26" fill="none" viewBox="0 0 24 24">
        <path d="M17 20c0-2.21-2.239-4-5-4s-5 1.79-5 4" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round"/>
        <circle cx="12" cy="8" r="4" stroke="currentColor" strokeWidth="1.7"/>
        <path d="M23 20c0-1.864-1.567-3.411-3.5-3.5M20.5 8a3.5 3.5 0 0 1 0 7" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round"/>
        <path d="M1 20c0-1.864 1.567-3.411 3.5-3.5M3.5 8a3.5 3.5 0 0 0 0 7" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round"/>
      </svg>
    ),
  },
  {
    ...
    svg: (
      <svg width="26" height="26" fill="none" viewBox="0 0 24 24">
        <path d="M3 17l4-4 4 4 4-6 4 3" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round"/>
  ...
  },
  {
    ...
    svg: (
      <svg width="26" height="26" fill="none" viewBox="0 0 24 24">
        ...
        <path d="M3 9h18M8 4V2M16 4V2" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round"/>
        <path d="M7 13h2m4 0h2M7 17h2m4 0h2" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round"/>
      </svg>
    ),
  },
  {
...
const IconWallet = () => (
  <svg width="13" height="13" fill="none" viewBox="0 0 24 24">
    ...
    <path d="M2 10h20M16 16h2" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round"/>
  </svg>
)
const IconSend = () => (
      ...
      <div className="vm-modal" onClick={(e) => e.stopPropagation()}>
        <div className="vm-modal__head">
          <div>
            ...
            <p className="vm-modal__subtitle">Bu vakansiya üçün müraciət forması</p>
          </div>
        ...
        <div className="vm-modal__row">
          <div className="vm-modal__field">
            ...
            <div className="vm-modal__file">
              <span className="vm-modal__file-name">{fileName || 'CV faylı'}</span>
  ...
  return (
    <div className="vm">
            ...
            {vacancies.map((v) => (
              <article className="vm-card" key={v.id}>
                ...
                <ul className="vm-card__meta">
                  <li><IconLocation />{v.location}</li>
                  <li><IconClock />{v.type}</li>
                  <li><IconWallet />{v.salary}</li>
                </ul>
                ...
                <ul className="vm-card__reqs">
                  {v.requirements.map((r, i) => (
                    <li key={i}><span className="vm-card__check" />{r}</li>
                  ))}
                </ul>

                <button className="vm-card__btn" onClick={() => setSelectedVacancy(v)}>
                  <IconSend /> Müraciət et
                </button>
              </article>
            ))}
      ...
      <section className="vm-why">
        <div className="vm__container">
          <div className="vm-section-head">
            <h2 className="vm-section-head__title">Niyə Bizimlə İşləməlisiniz?</h2>
            <p className="vm-section-head__sub">Platformamızda işləməyin üstünlükləri və karyera imkanları</p>
          </div>
      ...
      {selectedVacancy && (
        <Modal vacancy={selectedVacancy} onClose={() => setSelectedVacancy(null)} />
      )}
    </div>
  )
}
